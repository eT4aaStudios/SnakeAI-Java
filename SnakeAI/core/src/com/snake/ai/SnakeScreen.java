...
public class SnakeScreen implements Screen {
    ...
    public void drawFonts() {
        ...
        font.draw(batch, "Start length: " + settings.startLength, w / 3.35f, h / 1.54f);
        font.draw(batch, "Max Energy: " + settings.maxEnergy, w / 3.35f, h / 1.62f);
        font.draw(batch, "______________________", w / 3.35f, h / 1.65f);
        font.draw(batch, "Input Layer Nodes: " + settings.inputLayerNodes, w / 3.35f, h / 1.76f);
        font.draw(batch, "Layer 2 Nodes: " + settings.layer2Nodes, w / 3.35f, h / 1.86f);
        font.draw(batch, "Layer 3 Nodes: " + settings.layer3Nodes, w / 3.35f, h / 1.97f);
        font.draw(batch, "Layer 4 Nodes: " + settings.layer4Nodes, w / 3.35f, h / 2.09f);
        font.draw(batch, "Output Layer Nodes: " + settings.outputLayerNodes, w / 3.35f, h / 2.25f);
        font.draw(batch, "______________________", w / 3.35f, h / 2.34f);
        font.draw(batch, "Best Snakes Array Size: " + settings.bestSnakesArraySize, w / 3.35f, h / 2.6f);
        font.draw(batch, "Population Size: " + settings.POPULATIONSIZE, w / 3.35f, h / 2.87f);
        font.draw(batch, "Mutation Probability: " + (float) settings.mutationProbability, w / 3.35f, h / 3.2f);
        font.draw(batch, "Mutation Max: " + (float) settings.mutationMax, w / 3.35f, h / 3.6f);
        font.draw(batch, "Crossover: " + settings.crossover, w / 3.35f, h / 4.1f);
